...
//     // ✅ event
//     const selectedEvent = event && event._id === eid ? event : null;

//     if (!selectedEvent) {
//         return <p className="text-white text-center mt-10">No booking found</p>;
//     }

//     // 🔥 YOUR LOGIC (same as BookTicket)
//     const seats = 1; // ⚠️ default (or get from backend if available)

//     const subtotal = (selectedEvent.ticketPrice || 0) * seats;
...
//                                 <p className="text-zinc-300 text-xs font-mono">#DSTRQ-{events._id.toUpperCase()}-2025</p>
//                             </div>
//                         </div>
...
//                     {[
//                         { label: "Ticket Price (×2)", val: `₹${(events.ticketPrice * 2).toLocaleString()}` },
//                         { label: "Coupon — DSTRQ20", val: "− ₹300", green: true },
...
//                         <span className="text-[#C8F135] font-bold text-lg">{events.ticketPrice}</span>
//                     </div>
//                 </motion.div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-zinc-300 text-xs font-mono">
                                    #DSTRQ-{String(events._id).toUpperCase()}-2025
                                </p>
                            </div>
                        </div>
                        <span className="bg-[#C8F135]/10 border border-[#C8F135]/30 text-[#C8F135] text-xs font-bold px-4 py-2 rounded-full">
